...
<div class="container mt-4">
  <h2>Edit Kategori Ruangan</h2>

  <form action="<?= base_url('kategori-ruangan/update/' . $kategori['id']) ?>" method="post">
    <div class="mb-3">
    ...
    <a href="<?= base_url('kategori-ruangan') ?>" class="btn btn-secondary">Kembali</a>
  </form>
</div>
